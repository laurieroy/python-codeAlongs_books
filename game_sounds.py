...
while choice != 0:
    ...
    choice = input(prompt)
print("You asked {} questions").format(str(count_questions))
print("{} were answered correctly").format(str(count_right))
print("{} were answered incorrectly").format(str(count_wrong))
